...
Public Class ReportesNoRea

    Private Sub ReportesNoRea_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.QuejasTableAdapter.noRea(Me.QuejasDataSet.Quejas)
